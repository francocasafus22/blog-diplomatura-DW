...
export default function ExplorePage(){
    ...
    return (
        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-0 my-5 space-y-10">

            <h1 className="text-5xl font-bold">Explore</h1>
            <form className="flex w-full items-center gap-2" onSubmit={(e)=>onSubmit(e)}>
                <Input value={search} onChange={(e)=>setSearch(e.target.value)} placeholder="Search note by title"/>
